...
for i in `python generate_weeks.py`; do
    if [ ! -f "SFB1305_7_$i.csv" ]; then
        curl "http://tidesandcurrents.noaa.gov/noaacurrents/DownloadPredictions?fmt=csv&id=SFB1305_7&d=$i&r=2&t=24hr&u=1&tz=GMT&i=6min" -o SFB1305_7_$i.csv
    fi
done

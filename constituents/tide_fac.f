...
C-- DETERMINE GREENWICH EQUIL. TERMS AT BEGINNING OF RECORD
      ...
      WRITE(11,*) 'CONST   NODE     EQ ARG (ref GM)         SPEED'
      WRITE(11,1300)
 1300 FORMAT(' NAME   FACTOR   (DEG)                   (DEG/HR)',//)
...
C EQUILIBRIUM ARGUEMENT IS REFERENCED TO THE GRENWICH MERIDIAN
        ...
        WRITE(11,*) CNAME(IC),NODFAC(IC),GRTERM(IC),SPEED(IC)
C 2001   FORMAT(1X,A4,2x,F12.7,4x,F12.7,2x,F12.7)
   20   CONTINUE
